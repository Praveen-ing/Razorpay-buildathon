...
async def _handle_input(
    ...
    callbacks: list[Any] = []
    if settings.LANGFUSE_TRACING and CallbackHandler is not None:
...
# Mounted from service/recovery_router.py
# All recovery logic is centralized in the orchestrator.
# This service is the transport layer only.
# ==========================================

from service.recovery_router import recovery_router
